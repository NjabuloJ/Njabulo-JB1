    ...
    await client.sendMessage(groupId, {
      ...
      contextInfo: {
        externalAdReply: {
          ...
          mediaType: 1,
          thumbnailUrl: thumb,
          title: "𝗡𝗝𝗔𝗕𝗨𝗟𝗢 𝗝𝗕 APK Download",
          body: appDetails.BK9.name,
          sourceUrl:  'https://whatsapp.com/channel/0029VarYP5iAInPtfQ8fRb2T' , // Using configured source URL
    ...
    await zk.sendMessage(dest, {
      ...
      contextInfo: {
        externalAdReply: {
          ...
          body: "𝗡𝗝𝗔𝗕𝗨𝗟𝗢 𝗝𝗕",
          thumbnailUrl: "https://catbox.moe/loar6d.jpg" ,
