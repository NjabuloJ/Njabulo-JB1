...
module.exports = { session: process.env.SESSION_ID || 'Njabulo-Jb',
    PREFIXE: process.env.PREFIX || "+",
    GITHUB : process.env.GITHUB|| 'https://github.com/NjabuloJ/Njabulo-JB1',
    ...
    URL: process.env.URL || "https://files.catbox.moe/xfn913.jpg",  
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || 'viewed by Njabulo Jb',   
    ...
    BOT : process.env.BOT_NAME || '𝗡𝗝𝗔𝗕𝗨𝗟𝗢-𝗝𝗕',
